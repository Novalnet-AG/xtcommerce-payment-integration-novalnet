...
/**
 * xt_novalnet_onlinebanktransfer Class
 */

class xt_novalnet_Onlinebanktransfer
{
	/**
	 ...
	 * @var string
	 */
	public $code         = 'xt_novalnet_onlinebanktransfer';
	 ...
	 * @var string
	 */
	public $TARGET_URL   = 'https://payport.novalnet.de/online_banktransfer';
