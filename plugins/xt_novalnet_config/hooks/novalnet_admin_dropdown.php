...
switch($request['get']) {
	...
	case 'plg_xt_novalnet_sepa_fraud_prevention_types': // Fraud Prevention Types
		$result = array(
			array(
				  'id'   => 'none',
				  'name' => XT_NOVALNET_SEPA_NONE_TEXT,
				  'desc' => '',
			),
			array(
				  'id'   => 'CALLBACK',
				  'name' => XT_NOVALNET_SEPA_PIN_CALLBACK_TEXT,
				  'desc' => '',
			),
			array(
				  'id'   => 'SMS',
				  'name' => XT_NOVALNET_SEPA_PIN_SMS_TEXT,
				  'desc' => '',
			));
	break;
	case 'plg_xt_novalnet_invoice_fraud_prevention_types': // Fraud Prevention Types
		$result = array(
			array(
				  'id'   => 'none',
				  'name' => XT_NOVALNET_INVOICE_NONE_TEXT,
				  'desc' => '',
			),
			array(
				  'id'   => 'CALLBACK',
				  'name' => XT_NOVALNET_INVOICE_PIN_CALLBACK_TEXT,
				  'desc' => '',
			),
			array(
				  'id'   => 'SMS',
				  'name' => XT_NOVALNET_INVOICE_PIN_SMS_TEXT,
				  'desc' => '',
			));
	break;
