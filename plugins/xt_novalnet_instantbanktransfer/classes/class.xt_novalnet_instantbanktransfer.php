...
/**
 * xt_novalnet_instantbanktransfer Class
 */

class xt_novalnet_instantbanktransfer
{
    /**
	 ...
	 * @var string
	 */
	public $code         = 'xt_novalnet_instantbanktransfer';
	 ...
	 * @var string
	 */
	public $TARGET_URL   = 'https://payport.novalnet.de/online_transfer_payport';
	
	/**
	 * Constructor
	 *
	 */
    function xt_novalnet_instantbanktransfer()
    {
