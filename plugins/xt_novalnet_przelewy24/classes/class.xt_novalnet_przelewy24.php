...
/**
 * xt_novalnet_przelewy24 Class
 */

class xt_novalnet_przelewy24
{
	/**
	 ...
	 * @var string
	 */
	public $code         = 'xt_novalnet_przelewy24';
	 ...
	 * @var string
	 */
	public $TARGET_URL   = 'https://payport.novalnet.de/globalbank_transfer';
	
	/**
	 * Constructor
	 *
	 */
    function xt_novalnet_przelewy24 ()
    {
